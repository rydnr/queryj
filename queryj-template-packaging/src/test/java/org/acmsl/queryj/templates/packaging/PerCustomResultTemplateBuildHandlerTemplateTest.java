 ...
 ******************************************************************************
 *
 * Filename: PerCustomResultTemplateBuildHandlerTemplateTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for PerCustomResultTemplateBuildHandlerTemplate.
 *
 * Date: 2014/04/25
 * Time: 18:36
 *
...
/**
 * Tests for {@link PerCustomResultTemplateBuildHandlerTemplate}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/04/25 18:36
 */
@RunWith(JUnit4.class)
public class PerCustomResultTemplateBuildHandlerTemplateTest
{
    /**
