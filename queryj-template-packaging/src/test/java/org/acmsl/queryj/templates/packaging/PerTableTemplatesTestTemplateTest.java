 ...
 ******************************************************************************
 *
 * Filename: PerTableTemplateTestTemplateTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for PerTableTemplatesTestTemplate.
 *
 * Date: 2014/04/16
 * Time: 16:12
 *
...
/**
 * Tests for {@link PerTableTemplatesTestTemplate}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/04/16 16:12
 */
@RunWith(JUnit4.class)
public class PerTableTemplatesTestTemplateTest
{
    /**
