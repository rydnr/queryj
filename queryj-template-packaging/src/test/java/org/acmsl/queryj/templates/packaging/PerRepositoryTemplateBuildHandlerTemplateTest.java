 ...
 ******************************************************************************
 *
 * Filename: PerRepositoryTemplateBuildHandlerTemplateTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for PerRepositoryTemplateBuildHandlerTemplate.
 *
 * Date: 2014/04/23
 * Time: 18:43
 *
...
/**
 * Tests for {@link PerRepositoryTemplateBuildHandlerTemplate}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/04/23 18:43
 */
@RunWith(JUnit4.class)
public class PerRepositoryTemplateBuildHandlerTemplateTest
{
    /**
