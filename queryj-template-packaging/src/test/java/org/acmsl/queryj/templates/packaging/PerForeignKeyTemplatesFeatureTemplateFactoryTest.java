 ...
 ******************************************************************************
 *
 * Filename: PerForeignKeyTemplatesFeatureTemplateFactoryTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for PerForeignKeyTemplatesFeatureTemplateFactory.
 *
 * Date: 2014/04/16
 * Time: 12:33
 *
...
/**
 * Tests for {@link PerForeignKeyTemplatesFeatureTemplateFactory}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/04/16 12:33
 */
@RunWith(JUnit4.class)
public class PerForeignKeyTemplatesFeatureTemplateFactoryTest
{
    /**
