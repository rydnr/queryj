                ...
                DefaultTemplatePackagingContext>
{
    ...
    {
        testCreateTemplate(TemplateDefType.PER_TABLE, Literals.PER_TABLE_TEMPLATE_BUILD_HANDLER);
    }
    ...
    {
        testCreateTemplate(TemplateDefType.PER_FOREIGN_KEY, Literals.PER_FOREIGN_KEY_TEMPLATE_BUILD_HANDLER);
    }
    ...
    {
        testCreateTemplate(TemplateDefType.PER_CUSTOM_RESULT, Literals.PER_CUSTOM_RESULT_TEMPLATE_BUILD_HANDLER);
    }
    ...
    {
        testCreateTemplate(TemplateDefType.PER_CUSTOM_SQL, Literals.PER_CUSTOM_SQL_TEMPLATE_BUILD_HANDLER);
    }
}