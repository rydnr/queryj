 ...
 ******************************************************************************
 *
 * Filename: PerTableTemplateWritingHandlerTemplateTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for PerTableTemplateWritingHandlerTemplate.
 *
 * Date: 2014/04/29
 * Time: 05:58
 *
...
/**
 * Tests for {@link PerTableTemplateWritingHandlerTemplate}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/04/29 05:58
 */
@RunWith(JUnit4.class)
public class PerTableTemplateWritingHandlerTemplateTest
{
    /**
