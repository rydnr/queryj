 ...
 ******************************************************************************
 *
 * Filename: TemplateFactoryTemplateBuildHandler.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Is responsible of building TemplateFactoryTemplates.
 *
 * Date: 2013/08/21
 * Time: 21:32
 *
...
/**
 * Is responsible of building {@link TemplateFactoryTemplate}s.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2013/08/21 21:32
 */
@ThreadSafe
                 ...
                 DefaultTemplatePackagingContext>
{
    ...
    @NotNull
    @Override
    protected TemplateFactoryTemplateFactory retrieveTemplateFactory()
    {
        return TemplateFactoryTemplateFactory.getInstance();
    }
