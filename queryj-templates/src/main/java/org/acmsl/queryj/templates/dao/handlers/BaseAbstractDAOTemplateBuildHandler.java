    ...
    extends  BasePerTableTemplateBuildHandler<BaseAbstractDAOTemplate, BaseAbstractDAOTemplateFactory>
{
    ...
    protected void storeTemplates(
        @NotNull final List<BaseAbstractDAOTemplate> templates,
        @NotNull final Map<String, List<BaseAbstractDAOTemplate>> parameters)
    {
    ...
    protected BaseAbstractDAOTemplate createTemplate(
      ...
      throws  QueryJBuildException
    {        
        @Nullable final BaseAbstractDAOTemplate result;
