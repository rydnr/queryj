 ...
 ******************************************************************************
 *
 * Filename: CucumberFeatureTemplateWritingHandler.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Writes Cucumber features.
 *
 */
    ...
    CucumberFeatureTemplateGenerator, BasePerRepositoryTemplateContext>
{
    ...
    @NotNull
    @Override
    protected CucumberFeatureTemplateGenerator retrieveTemplateGenerator(
        final boolean caching, final int threadCount)
    {
        return new CucumberFeatureTemplateGenerator(caching, threadCount);
    }
    ...
    protected List<CucumberFeatureTemplate> retrieveTemplates(
        @NotNull final Map parameters)
    {
        return
            (List<CucumberFeatureTemplate>)
                parameters.get(CucumberFeatureTemplateBuildHandler.class);
    }
