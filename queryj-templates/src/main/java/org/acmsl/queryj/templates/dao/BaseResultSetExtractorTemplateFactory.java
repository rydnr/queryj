 ...
 ******************************************************************************
 *
 * Filename: BaseResultSetExtractorTemplateFactory.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Is able to create BaseResultSetExtractorTemplate instances.
 *
 */
...
public class BaseResultSetExtractorTemplateFactory
    implements PerRepositoryTemplateFactory<BaseResultSetExtractorTemplate>,
                Singleton
{
    /**
     * Singleton implemented to avoid double-locking check.
     */
    protected static final class BaseResultSetExtractorTemplateFactorySingletonContainer
    {
        /**
         * The actual singleton.
         */
        public static final BaseResultSetExtractorTemplateFactory SINGLETON =
            new BaseResultSetExtractorTemplateFactory();
    }
     ...
     */
    @NotNull
    public static BaseResultSetExtractorTemplateFactory getInstance()
    {
        return BaseResultSetExtractorTemplateFactorySingletonContainer.SINGLETON;
    }
