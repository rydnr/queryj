                     ...
                     BaseResultSetExtractorTemplateFactory, BasePerRepositoryTemplateContext>
{
    ...
    protected void storeTemplate(
        @NotNull final BaseResultSetExtractorTemplate template,
        @NotNull final Map<String, List<BaseResultSetExtractorTemplate>> parameters)
    {
        @NotNull final List<BaseResultSetExtractorTemplate> list = new ArrayList<BaseResultSetExtractorTemplate>(1);
        list.add(template);
