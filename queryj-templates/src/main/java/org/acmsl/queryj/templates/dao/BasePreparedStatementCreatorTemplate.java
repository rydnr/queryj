...
{
    private static final long serialVersionUID = -7335842693550217767L;
     ...
     */
    public BasePreparedStatementCreatorTemplate(@NotNull final PerRepositoryTemplateContext context)
    {
        super(context);
    }
