 ...
 *
 * Description: Is able to create CustomValueObjectFactoryTemplate instances.
 *
 */
...
/**
 * Is able to create {@link CustomValueObjectFactoryTemplate} instances.
 * @author <a href="mailto:chous@acm-sl.org">Jose San Leandro Armendariz</a>
 * @since 2012/07/09
 */
@ThreadSafe
public class CustomValueObjectFactoryTemplateFactory
    implements PerCustomResultTemplateFactory<CustomValueObjectFactoryTemplate>,
                Singleton
{
    /**
     * Singleton implementation to avoid double-locking check.
     */
    protected static final class CustomValueObjectFactoryTemplateFactorySingletonContainer
    {
        /**
         * The actual singleton.
         */
        public static final CustomValueObjectFactoryTemplateFactory SINGLETON =
            new CustomValueObjectFactoryTemplateFactory();
    }
     ...
     */
    @NotNull
    public static CustomValueObjectFactoryTemplateFactory getInstance()
    {
        return CustomValueObjectFactoryTemplateFactorySingletonContainer.SINGLETON;
    }
