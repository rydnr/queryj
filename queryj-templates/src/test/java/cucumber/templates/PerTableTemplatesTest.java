/*
    ...
    Copyright (C) -today Jose San Leandro Armendariz
                              queryj@acm-sl.org
 ...
 */
// Generated by QueryJ using org/acmsl/queryj/templates/PerTableTemplatesTest.stg
 ...
 * Generation template: org/acmsl/queryj/dao/PerTableTemplatesTest.stg
 * Created: 2013/11/11 09:20
 */
    ...
    extends AbstractTemplatesTest<PerTableTemplateGenerator, PerTableTemplateFactory>
{
    ...
    public PerTableTemplatesTest()
    {
        ...
        PACKAGE_MAPPINGS.put("DAOFactory", resolvePackage("<packageName>.dao"));
        ...
        PACKAGE_MAPPINGS.put("BaseDAOFactory", resolvePackage("<packageName>.dao.rdb"));
    }
...
//            Assert.assertTrue("Cannot create folder: " + outputDir.getAbsolutePath(), outputDir.mkdirs());
     ...
     */
    @NotNull
    protected String resolvePackage(@NotNull final String packageTemplate)
    {
        @NotNull final String result;

        @NotNull final ST template = new ST(packageTemplate);
        template.add("packageName", "com.foo.bar");
