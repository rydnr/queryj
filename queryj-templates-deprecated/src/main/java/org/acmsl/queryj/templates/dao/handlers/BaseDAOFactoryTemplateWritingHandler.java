...
public class BaseDAOFactoryTemplateWritingHandler
    extends  BasePerTableTemplateWritingHandler
                 <BaseDAOFactoryTemplate, BaseDAOFactoryTemplateGenerator, PerTableTemplateContext>
{
    /**
    ...
    @NotNull
    @Override
    protected BaseDAOFactoryTemplateGenerator retrieveTemplateGenerator(final boolean caching, final int threadCount)
    {
        return new BaseDAOFactoryTemplateGenerator(caching, threadCount);
    }
