...
public class RepositoryDAOFactoryTemplateBuildHandler
    ...
    RepositoryDAOFactoryTemplate, RepositoryDAOFactoryTemplateFactory, PerRepositoryTemplateContext>
{
    /**
    ...
    protected void storeTemplate(
        @NotNull final RepositoryDAOFactoryTemplate template,
        @NotNull final Map<String, List<RepositoryDAOFactoryTemplate>> parameters)
    {
        @NotNull final List<RepositoryDAOFactoryTemplate> list = new ArrayList<RepositoryDAOFactoryTemplate>(1);
        list.add(template);
