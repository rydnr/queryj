...
public class RepositoryDAOTemplateWritingHandler
    extends BasePerRepositoryTemplateWritingHandler<RepositoryDAOTemplate,
    ...
    PerRepositoryTemplateContext>
{
    ...
    @Nullable
    @Override
    protected List<RepositoryDAOTemplate> retrieveTemplates(
        @NotNull final Map<String, List<RepositoryDAOTemplate>> parameters)
    {
        return parameters.get(TemplateMappingManager.REPOSITORY_DAO_TEMPLATE);
    }
