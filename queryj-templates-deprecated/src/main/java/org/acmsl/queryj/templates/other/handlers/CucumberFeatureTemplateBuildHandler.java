                ...
                <CucumberFeatureTemplate, CucumberFeatureTemplateFactory, PerRepositoryTemplateContext>
{
    ...
    protected void storeTemplate(
        @NotNull final CucumberFeatureTemplate template,
        @NotNull final Map<String, List<CucumberFeatureTemplate>> parameters)
    {
        @NotNull final List<CucumberFeatureTemplate> list = new ArrayList<CucumberFeatureTemplate>(1);
        list.add(template);
