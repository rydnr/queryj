...
/**
 * Is able to create QueryPreparedStatementCreatorengine-specific  interfaces for each
 * table in the persistence model.
...
{
    /**
     * Builds a <code>QueryPreparedStatementCreatorTemplate</code> using given information.
    ...
    {
        return "//QueryPreparedStatementCreatorTemplate//";
    }
    ...
    {
        return retrieveGroup("/org/acmsl/queryj/dao/QueryPreparedStatementCreator.stg");
    }
    ...
    {
        return "QueryPreparedStatementCreator";
    }
}
