...
{
    /**
     * Builds a <code>JdbcTemplateTemplate</code> using given information.
    ...
    {
        return retrieveGroup("/org/acmsl/queryj/dao/JdbcTemplate.stg");
    }
