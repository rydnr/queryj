                ...
                Utils
{
        ...
        final CustomSqlProvider customSqlProvider)
    {
        ...
        if  (customSqlProvider != null)
        {
                 ...
                 && (t_cConnectionFlags.size() > 0))
            {
                ...
                {
                    t_cResult.add(
                        ((ConnectionFlags) t_itConnectionFlags.next())
    ...
    {
        return filterItems(contents, ConnectionFlags.class, idFilter);
    }
        ...
        final CustomSqlProvider customSqlProvider)
    {
        ...
        if  (customSqlProvider != null)
        {
                 ...
                 && (t_cStatementFlags.size() > 0))
            {
                ...
                StatementFlags t_Statement =
                    (StatementFlags) t_itStatementFlags.next();
    ...
    protected Collection filterStatementFlags(
        final Collection contents, final String idFilter)
    {
        return filterItems(contents, StatementFlags.class, idFilter);
    }
        ...
        final CustomSqlProvider customSqlProvider)
    {
        ...
        if  (customSqlProvider != null)
        {
                 ...
                 && (t_cResultSetFlags.size() > 0))
            {
                ...
                // There should be only one.
                ResultSetFlags t_ResultSet =
                    (ResultSetFlags) t_itResultSetFlags.next();
    ...
    protected Collection filterResultSetFlags(
        final Collection contents, final String idFilter)
    {
        return filterItems(contents, ResultSetFlags.class, idFilter);
    }
    ...
    /**
     * Retrieves all <code>Property</code> instances associated to
     ...
     */
    public Property[] retrievePropertyElementsByResultId(
        final CustomSqlProvider customSqlProvider,
        final Result resultElement)
    {
                ...
                while  (t_itPropertyRefs.hasNext())
                {
                    t_cResult.add(
                        customSqlProvider.resolveReference(
                            (PropertyRef) t_itPropertyRefs.next()));
                }
            }
        }
        ...
        return
            (Property[])
                t_cResult.toArray(EMPTY_PROPERTY_ARRAY);
    }
