    ...
    implements SqlPropertyDAO
{
    ...
    {
        // TODO: I need a ResultDAO instance.
        return new ArrayList<Property>(2);
    }
     ...
     */
    @Override
    public void insert(@NotNull final String name, @NotNull final String tableName, @NotNull final String type)
    {
        insert(name, tableName, type, getSqlXmlParser());
    }
    ...
    {
        parser.addProperty(name, tableName, type);
    }
}