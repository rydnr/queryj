...
public class AbstractRefactoredJdbcMetadataManager
    implements RefactoredMetadataManager
{
    /**
     * The manager name.
     */
     ...
     */
    @SuppressWarnings("unused")
    protected AbstractRefactoredJdbcMetadataManager(@NotNull final String name)
    {
