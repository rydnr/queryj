    ...
    extends DAO
{
     ...
     */
    @Nullable
    Parameter findByPrimaryKey(@NotNull final String id);

    /**
     * Retrieves all {@link Parameter parameters} used in given {@link org.acmsl.queryj.tools.customsql.Sql}.
     ...
     */
    @NotNull
    List<Parameter> findBySql(@NotNull final String sqlId);
}
