 ...
 */
import org.acmsl.queryj.tools.templates.handlers.fillhandlers.BasePerCustomResultFillTemplateChain;
    ...
    extends  AbstractBasePerCustomResultTemplate<C>
{
     ...
     * @return the specific {@link org.acmsl.queryj.tools.templates.InvalidTemplateException} for the template.
     */
    @NotNull
    @Override
