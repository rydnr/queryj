...
{
    /**
     * Builds a <code>StatisticsProviderTemplate</code> using given information.
     ...
     */
    public StatisticsProviderTemplate(
    ...
    {
        return retrieveGroup("/org/acmsl/queryj/dao/StatisticsProvider.stg");
    }
