 ...
 *
 * Description: Is able to create JndiUtils sources.
 *
 */
...
/**
 * Is able to create JndiUtils sources.
...
{
    /**
     * Builds a <code>JndiUtilsTemplate</code> using given information.
