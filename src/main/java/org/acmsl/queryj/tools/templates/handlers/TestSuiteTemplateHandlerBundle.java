 ...
 ******************************************************************************
 *
 * Filename: TestSuiteTemplateHandlerBundle.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Bundles a pair of TestSuite template build and writing
 *              handlers.
 *
 */
...
/**
 * Bundles a pair of TestSuite template build and writing
 * handlers.
 * @author <a href="mailto:chous@acm-sl.org">Jose San Leandro Armendariz</a>
 */
public class TestSuiteTemplateHandlerBundle
    extends  TemplateHandlerBundle
{
     ...
     */
    public TestSuiteTemplateHandlerBundle()
    {
        super(
            new TestSuiteTemplateBuildHandler(),
            new TestSuiteTemplateWritingHandler());
    }
}
