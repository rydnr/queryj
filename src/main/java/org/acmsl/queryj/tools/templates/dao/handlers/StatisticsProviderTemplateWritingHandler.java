 ...
 *
 * Description: Writes the StatisticsProvider template.
 *
 */
...
import org.acmsl.queryj.tools.templates.dao.handlers.StatisticsProviderTemplateBuildHandler;
import org.acmsl.queryj.tools.templates.handlers.BasePerRepositoryTemplateWritingHandler;
import org.acmsl.queryj.tools.templates.dao.StatisticsProviderTemplateGenerator;
...
/**
 * Writes the StatisticsProvider template.
        ...
        final Map parameters)
    {
        return
            (BasePerRepositoryTemplate)
                parameters.get(TemplateMappingManager.STATISTICS_PROVIDER_TEMPLATE);
    }
