 ...
 ******************************************************************************
 *
 * Filename: ConfigurationPropertiesTemplateHandlerBundle.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Bundles a pair of ConfigurationProperties template build and writing
 *              handlers.
 *
 */
    ...
    extends  TemplateHandlerBundle
{
     ...
     */
    public ConfigurationPropertiesTemplateHandlerBundle()
    {
        super(
            new ConfigurationPropertiesTemplateBuildHandler(),
            new ConfigurationPropertiesTemplateWritingHandler());
    }
}
