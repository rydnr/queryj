 ...
 ******************************************************************************
 *
 * Filename: XMLDAOTemplateHandlerBundle.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Bundles a pair of XMLDAO template build and writing
 *              handlers.
 *
 */
...
/**
 * Bundles a pair of template XMLDAO template build and writing
 * handlers.
 * @author <a href="mailto:chous@acm-sl.org">Jose San Leandro Armendariz</a>
 */
public class XMLDAOTemplateHandlerBundle
    extends  TemplateHandlerBundle
{
     ...
     */
    public XMLDAOTemplateHandlerBundle()
    {
        super(
            new XMLDAOTemplateBuildHandler(),
            new XMLDAOTemplateWritingHandler());
    }
}
