 ...
 *
 * Description: Resolves "class_name" placeholders for DAO interfaces.
 *
 * Date: 5/24/12
 * Time: 5:12 AM
 *
...
/**
 * Resolves "class_name" placeholders for DAO interfaces.
 * @author <a href="mailto:chous@acm-sl.org">chous</a>
 * @since 2012/05/24
 */
@SuppressWarnings("unused")
public class DAOClassNameHandler
    extends ClassNameHandler<BasePerTableTemplateContext>
{
    /**
