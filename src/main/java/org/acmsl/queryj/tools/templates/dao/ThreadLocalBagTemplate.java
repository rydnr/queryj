...
{
    /**
     * Builds a <code>ThreadLocalBagTemplate</code> using given information.
    ...
    {
        return retrieveGroup("/org/acmsl/queryj/dao/ThreadLocalBag.stg");
    }
