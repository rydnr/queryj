 ...
 ******************************************************************************
 *
 * Filename: ProcedureRepositoryTemplateHandlerBundle.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Bundles a pair of ProcedureRepository template build and writing
 *              handlers.
 *
 */
 ...
 */
public class ProcedureRepositoryTemplateHandlerBundle
    extends  TemplateHandlerBundle
{
     ...
     */
    public ProcedureRepositoryTemplateHandlerBundle()
    {
        super(
            new ProcedureRepositoryTemplateBuildHandler(),
            new ProcedureRepositoryTemplateWritingHandler());
    }
}
