 ...
 ******************************************************************************
 *
 * Filename: ResultSetFlagsRefElementFactory.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Is able to create sql.xml <resultset-flags-ref> element
...
/**
 * Is able to create sql.xml &lt;resultset-flags-ref&gt; element instances
 * from their attributes, while being parsed by Digester.
 * @author <a href="mailto:chous@acm-sl.org"
 *         >Jose San Leandro</a>
 */
public class ResultSetFlagsRefElementFactory
    extends  ElementFactory
{
    /**
     * Creates a ResultSetFlagsRefElementFactory instance.
     */
    public ResultSetFlagsRefElementFactory() {};

    /**
     * Creates a ResultSetFlagsRefElement instance from given SAX attributes.
    ...
    public Object createObject(
      ...
      throws SAXException
    {
        ResultSetFlagsRefElement result = null;
