 ...
 ******************************************************************************
 *
 * Filename: ImplicitIntProperty.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Represents implicit integer properties.
 *
 */
...
/**
 * Represents implicit integer properties.
 * @author <a href="mailto:chous@acm-sl.org"
 *         >Jose San Leandro</a>
 */
public class ImplicitIntProperty
    extends  AbstractImplicitProperty
{
    /**
     * Creates an <code>ImplicitIntProperty</code> with given information.
