 ...
 ******************************************************************************
 *
 * Filename: ImplicitFloatProperty.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Represents implicit float properties.
 *
 */
...
/**
 * Represents implicit float properties.
 * @author <a href="mailto:chous@acm-sl.org"
 *         >Jose San Leandro</a>
 */
public class ImplicitFloatProperty
    extends  AbstractImplicitProperty
{
    /**
     * Creates an <code>ImplicitFloatProperty</code> with given information.
