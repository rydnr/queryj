    ...
    extends AbstractDecoratedStringHandler<TemplateContext>
{
    ...
    {
        return retrievePropertiesFileName(context.getRepositoryName(), DAOChooserTemplateUtils.getInstance());
    }

    /**
     * Retrieves the name of the properties file, based on given repository name.
     * @param repositoryName the name of the repository.
     * @param daoChooserTemplateUtils the {@link DAOChooserTemplateUtils} instance.
     * @return the name of the properties file.
     */
    @NotNull
    protected String retrievePropertiesFileName(
        @NotNull final String repositoryName, @NotNull final DAOChooserTemplateUtils daoChooserTemplateUtils)
    {
        return daoChooserTemplateUtils.retrievePropertiesFileName(repositoryName);
    }
}
