 ...
 ******************************************************************************
 *
 * Filename: BooleanField.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Represents boolean fields.
 *
 */
...
{
    /**
     * Creates a boolean field using given information.
     * @param name the field name.
     * @param table the table.
     * @precondition name != null
     * @precondition table != null
     */
    public BooleanField(final String name, final Table table)
    {
        super(name, table);
    }
     ...
     */
    public Condition equals(final boolean value)
    {
        return
            equals(
                value,
     ...
     * @return such kind of condition.
     */
    public Condition notEquals(final boolean value)
    {
        return
            notEquals(
                value,
