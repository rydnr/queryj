    ...
    implements  PreparedStatement
{
     ...
     * @param length         the number of characters in the parameter data.
     * @throws java.sql.SQLException if parameterIndex does not correspond to a parameter
     *                               marker in the SQL statement; if a database access error occurs; this method is
     *                               called on
     *                               a closed <code>PreparedStatement</code> or if the length specified is less than
     *                               zero.
     * @throws java.sql.SQLFeatureNotSupportedException
     *                               if the JDBC driver does not support this method
     * @since 1.6
     ...
     *                               marker in the SQL statement; if a database access error occurs; this method is
     *                               called on
     *                               a closed <code>PreparedStatement</code>or if parameterIndex does not correspond
     *                               to a parameter
