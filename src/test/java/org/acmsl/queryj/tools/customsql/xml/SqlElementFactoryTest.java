...
******************************************************************************
*
* Filename: SqlElementFactoryTest.java
*
...
// JUnitDoclet end extends_implements
{
  ...
  /**
  * Creates a SqlElementFactoryTest with given name.
  * @param name such name.
  */
  public SqlElementFactoryTest(String name)
  {
    // JUnitDoclet begin method SqlElementFactoryTest
    super(name);
    // JUnitDoclet end method SqlElementFactoryTest
  }
  ...
  */
  ...
  throws Exception
  {
    ...
    super.setUp();
    sqlelementfactory = createInstance();
  ...
  */
  ...
  public static void main(String[] args)
  {
    ...
    junit.textui.TestRunner.run(SqlElementFactoryTest.class);
