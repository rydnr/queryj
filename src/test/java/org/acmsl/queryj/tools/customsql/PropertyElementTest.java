...
******************************************************************************
*
* Filename: PropertyElementTest.java
*
...
// JUnitDoclet end extends_implements
{
  ...
  /**
  * Creates a PropertyElementTest with given name.
  * @param name such name.
  */
  public PropertyElementTest(String name)
  {
    // JUnitDoclet begin method PropertyElementTest
    super(name);
    // JUnitDoclet end method PropertyElementTest
  }
  ...
  */
  ...
  throws Exception
  {
    ...
    super.setUp();
    propertyelement = createInstance();
  ...
  */
  ...
  public static void main(String[] args)
  {
    ...
    junit.textui.TestRunner.run(PropertyElementTest.class);
