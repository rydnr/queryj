    ...
    implements TemplateWritingHandler
{
            ...
            try 
            {
                     ...
                     && (t_ValueObjectTemplateGenerator != null))
                {
                    for  (int t_iValueObjectIndex = 0;
                              ...
                              t_iValueObjectIndex++)
                    {
                        t_ValueObjectTemplateGenerator.write(
                            t_aValueObjectTemplates[t_iValueObjectIndex], t_OutputDir);
                    }
                }
            }
     ...
     */
    protected ValueObjectTemplate[] retrieveValueObjectTemplates(Map parameters)
        throws  BuildException
    {
        ValueObjectTemplate[] result = EMPTY_VALUE_OBJECT_TEMPLATE_ARRAY;
