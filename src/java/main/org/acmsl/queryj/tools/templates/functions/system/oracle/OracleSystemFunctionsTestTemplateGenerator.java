    ...
    extends  SystemFunctionsTestTemplateGenerator
{
     ...
     */
    protected static void setReference(OracleSystemFunctionsTestTemplateGenerator generator)
    {
    ...
    {
        OracleSystemFunctionsTestTemplateGenerator result = null;

        WeakReference reference = getReference();

        if  (reference != null) 
        {
            result = (OracleSystemFunctionsTestTemplateGenerator) reference.get();
        }

        if  (result == null) 
        {
            result = new OracleSystemFunctionsTestTemplateGenerator() {};
