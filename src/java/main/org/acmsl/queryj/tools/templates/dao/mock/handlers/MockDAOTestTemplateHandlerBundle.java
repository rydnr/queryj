 ...
 ******************************************************************************
 *
 * Filename: MockDAOTestTemplateHandlerBundle.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Bundles a pair of MockDAOTest template build and writing
 *              handlers.
 *
 */
...
/**
 * Bundles a pair of MockDAOTest template build and writing
 * handlers.
 * @author <a href="mailto:chous@acm-sl.org">Jose San Leandro</a>
 */
public class MockDAOTestTemplateHandlerBundle
    extends  TemplateHandlerBundle
{
    ...
    {
        super(
            new MockDAOTestTemplateBuildHandler(),
            new MockDAOTestTemplateWritingHandler());
    }
}
