                ...
                BasePerTableTemplateGenerator
{
    ...
    {
        AttributesStatementSetterTemplateGenerator result = null;
        ...
        {
            result =
                (AttributesStatementSetterTemplateGenerator) reference.get();
        }

        if  (result == null) 
        {
            result = new AttributesStatementSetterTemplateGenerator();
