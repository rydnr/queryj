    ...
    implements TemplateWritingHandler
{
        ...
        if  (command != null) 
        {
            try 
            {
                ...
                KeywordRepositoryTemplate t_KeywordRepositoryTemplate =
                    retrieveKeywordRepositoryTemplate(attributes);

                File t_OutputDir = retrieveOutputDir(attributes);

                if  (   (t_OutputDir                          != null) 
                     && (t_KeywordRepositoryTemplate          != null)
                     && (t_KeywordRepositoryTemplateGenerator != null))
                {
                    t_KeywordRepositoryTemplateGenerator.write(
                        t_KeywordRepositoryTemplate, t_OutputDir);
                }
            }
        ...
        throws  BuildException
    {
        ...
        {
            result =
                t_PackageUtils.retrieveKeywordRepositoryFolder(
