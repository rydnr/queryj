    ...
    extends TableDecorator
{
    ...
    public String toString()
    {
        return
            new org.apache.commons.lang.builder.ToStringBuilder(this)
                ...
                .append("cachedUncapitalizedName", getCachedUncapitalizedName())
                .append("cachedVoName", getCachedVoName())
                .append("cachedNameNormalizedLowercased", getCachedNameNormalizedLowercased())
                .append("cachedSingularNameNormalizedLowercased", getCachedSingularNameNormalizedLowercased())
                .append("cachedNameNormalized", getCachedNameNormalized())
                .append("cachedSingularNameCapitalized", getCachedSingularNameCapitalized())
                .toString();
    }
    ...
    public boolean equals(final Object object)
    {
        ...
        if  (object instanceof CachingTableDecorator)
        {
            final CachingTableDecorator t_OtherInstance =
                (CachingTableDecorator) object;
            ...
            result =
                new org.apache.commons.lang.builder.EqualsBuilder()
                    ...
                    .append(
                        getCachedUncapitalizedName(),
                        t_OtherInstance.getCachedUncapitalizedName())
                    .append(
                    ...
                    .append(
                        getCachedNameNormalizedLowercased(),
                        t_OtherInstance.getCachedNameNormalizedLowercased())
                    .append(
                        getNameNormalizedLowercased(),
                        t_OtherInstance.getNameNormalizedLowercased())
                    .append(
                        getCachedSingularNameNormalizedLowercased(),
                        t_OtherInstance.getCachedSingularNameNormalizedLowercased())
                    .append(
                        getSingularNameNormalizedLowercased(),
                        t_OtherInstance.getSingularNameNormalizedLowercased())
                    .append(
                        getCachedNameNormalized(),
                        t_OtherInstance.getCachedNameNormalized())
                    .append(
                        getNameNormalized(),
                        t_OtherInstance.getNameNormalized())
                    .append(
                        getCachedSingularNameCapitalized(),
                        t_OtherInstance.getCachedSingularNameCapitalized())
                    .append(
