    ...
    extends  AbstractAttributeDecorator
{
    ...
    public String toString()
    {
        return
            new org.apache.commons.lang.builder.ToStringBuilder(this)
                ...
                .append(
                    "cachedNameUncapitalized", getCachedNameUncapitalized())
                .append("cachedNameLowercased", getCachedNameLowercased())
                .append(
                    "cachedUncapitalizedTableName",
                    getCachedUncapitalizedTableName())
                .append("cachedVoName", getCachedVoName())
                .append("cachedJavaName", getCachedJavaName())
                .append("cachedGetterMethod", getCachedGetterMethod())
                .append("cachedIsPrimitive", getCachedIsPrimitive())
                .append("cachedObjectType", getCachedObjectType())
                .append("cachedIsClob", getCachedIsClob())
                .append("cachedIsString", getCachedIsString())
                .append("cachedIsDate", getCachedIsDate())
                .append("cachedQuery", getCachedQuery())
                .append("cachedQueryJFieldType", getCachedQueryJFieldType())
                .append(
                    "cachedStatementSetterFieldType",
                    getCachedStatementSetterFieldType())
                .append(
                    "cachedTableNameUppercased",
                    getCachedTableNameUppercased())
                .append(
                    "cachedTableNameNormalizedLowercased",
                    getCachedTableNameNormalizedLowercased())
                .append(
                    "cachedNumberSmallerThanInt",
    ...
    public boolean equals(final Object object)
    {
        ...
        if  (object instanceof CachingAttributeDecorator)
        {
            final CachingAttributeDecorator t_OtherInstance =
                (CachingAttributeDecorator) object;
            ...
            result =
                new org.apache.commons.lang.builder.EqualsBuilder()
                    ...
                    .append(
                        getCachedUncapitalizedTableName(),
                        t_OtherInstance.getCachedUncapitalizedTableName())
                    .append(
                        getUncapitalizedTableName(),
                        t_OtherInstance.getUncapitalizedTableName())
                    .append(
                        getCachedVoName(),
                        t_OtherInstance.getCachedVoName())
                    .append(
                        getVoName(),
                        t_OtherInstance.getVoName())
                    .append(
                        getCachedJavaName(),
                        t_OtherInstance.getCachedJavaName())
                    .append(
                        getJavaName(),
                        t_OtherInstance.getJavaName())
                    .append(
                        getCachedGetterMethod(),
                        t_OtherInstance.getCachedGetterMethod())
                    .append(
                        getGetterMethod(),
                        t_OtherInstance.getGetterMethod())
                    .append(
                        getCachedIsPrimitive(),
                        t_OtherInstance.getCachedIsPrimitive())
                    .append(
                        isPrimitive(),
                    ...
                    .append(
                        getCachedIsString(),
                        t_OtherInstance.getCachedIsString())
                    .append(
                        isString(),
                        t_OtherInstance.isString())
                    .append(
                        getCachedIsDate(),
                        t_OtherInstance.getCachedIsDate())
                    .append(
                        isDate(),
                        t_OtherInstance.isDate())
                    .append(
                        getCachedQuery(),
                        t_OtherInstance.getCachedQuery())
                    .append(
                        getQuery(),
                        t_OtherInstance.getQuery())
                    .append(
                        getCachedQueryJFieldType(),
                        t_OtherInstance.getCachedQueryJFieldType())
                    .append(
                        getQueryJFieldType(),
                        t_OtherInstance.getQueryJFieldType())
                    .append(
                        getCachedStatementSetterFieldType(),
                        t_OtherInstance.getCachedStatementSetterFieldType())
                    .append(
                        getStatementSetterFieldType(),
                        t_OtherInstance.getStatementSetterFieldType())
                    .append(
                        getCachedTableNameUppercased(),
                        t_OtherInstance.getCachedTableNameUppercased())
                    .append(
                        getTableNameUppercased(),
                        t_OtherInstance.getTableNameUppercased())
                    .append(
                        getCachedTableNameNormalizedLowercased(),
                        t_OtherInstance.getCachedTableNameNormalizedLowercased())
                    .append(
