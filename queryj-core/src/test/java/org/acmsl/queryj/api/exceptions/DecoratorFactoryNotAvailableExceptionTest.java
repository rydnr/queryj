 ...
 ******************************************************************************
 *
 * Filename: DecoratorFactoryNotAvailableExceptionTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for DecoratorFactoryNotAvailableException.
 *
 * Date: 2014/03/28
 * Time: 07:43
 *
...
/**
 * Tests for {@link DecoratorFactoryNotAvailableException}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/03/28 07:43
 */
@RunWith(JUnit4.class)
public class DecoratorFactoryNotAvailableExceptionTest
{
    /**
