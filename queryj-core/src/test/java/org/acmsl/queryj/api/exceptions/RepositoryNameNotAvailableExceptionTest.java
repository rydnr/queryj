 ...
 ******************************************************************************
 *
 * Filename: RepositoryNameNotAvailableExceptionTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for RepositoryNameNotAvailableException.
 *
 * Date: 2014/03/28
 * Time: 18:36
 *
...
/**
 * Tests for {@link RepositoryNameNotAvailableException}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/03/28 18:36
 */
@RunWith(JUnit4.class)
public class RepositoryNameNotAvailableExceptionTest
{
    /**
