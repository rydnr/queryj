 ...
 ******************************************************************************
 *
 * Filename: FileNameNotAvailableException.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Represents the situation in which the file name (needed to
 *              write the result of rendering a template) is missing at runtime
 *              when it should not.
 *
 * Date: 2014/03/28
 * Time: 20:00
...
/**
 * Represents the situation in which the file name (needed to write the result of
 * rendering a template) is missing at runtime when it should not.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2014/03/28 20:00
 */
@ThreadSafe
