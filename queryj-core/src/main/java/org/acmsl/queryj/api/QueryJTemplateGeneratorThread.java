...
/**
 * {@link TemplateGeneratorThread} bound to QueryJ-specific classes.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 3.0
 * Created: 2013/08/15 09/00
 */
@ThreadSafe
public class QueryJTemplateGeneratorThread
    <T extends QueryJTemplate<C>, TG extends TemplateGenerator<T>, C extends QueryJTemplateContext>
    extends TemplateGeneratorThread<T, TG>
{
    /**
     ...
     */
    public QueryJTemplateGeneratorThread(
