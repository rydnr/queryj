 ...
 ******************************************************************************
 *
 * Filename: JdbcCLI.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Allows executing QueryJ for JDBC from the command-line.
 *
 */
...
/**
 * Allows executing QueryJ for JDBC from the command-line.
 * @author <a href="mailto:chous@acm-sl.org">Jose San Leandro Armendariz</a>
 * @since 1.0
 * Created: Thu Jul 13 18:21:23 2006
 */
public final class JdbcCLI
    implements  QueryJCLIOptions
{
    ...
    {
        executeQueryJ(args, JdbcCLIHelper.getInstance());
    }

    /**
     * Executes <b>QueryJ</b> from the command line.
     * @param args the command-line arguments.
     * @param helper the <code>JdbcCLIHelper</code> instance.
     */
    protected static void executeQueryJ(
        final String[] args, @NotNull final JdbcCLIHelper helper)
    {
        executeQueryJ(
            args,
    ...
    protected static void executeQueryJ(
        ...
        @NotNull final JdbcCLIHelper helper)
    {
